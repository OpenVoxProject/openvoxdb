...
(defproject org.openvoxproject/puppetdb "9.0.0-rc1-SNAPSHOT"
  ...
  :managed-dependencies [[org.clojure/clojure "1.12.6"]
                         ...
                         [com.taoensso/nippy "3.9.0" :exclusions [org.tukaani/xz]]
                         ...
                         [org.openvoxproject/stockpile "1.0.3"]
                         ...
                         [org.openvoxproject/trapperkeeper-metrics "2.3.2" :exclusions [io.dropwizard.metrics/metrics-core]]
  ...
  :profiles {
    ...
    :ezbake {:dependencies ^:replace [;; NOTE: we need to explicitly pass in `nil` values
                                      ...
                                      [org.openvoxproject/puppetdb "9.0.0-rc1-SNAPSHOT"]]
              :name "puppetdb"
